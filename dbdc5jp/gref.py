...
class Trainer():
    def __init__(self, args):
        ...
        train_data = self.load_data(read_json(self.task_config['train_data_path'])['data']*3, tokenizer, train=True)
    ...
    def run_process(self):
        ...
        for epoch in trange(epochs, desc='epoch'):
            ...
            if patience == patience_max or epoch == epochs - 1:
                torch.save(ckpt_best, ckpt_dsave + '/model.pt.tar'.format(epoch_best))
